...
CREATE TABLE `transferdetails` (
  ...
  `ulb_from` varchar(30) NOT NULL,
  `ulb_to` varchar(30) NOT NULL,
  `order_no` varchar(30) NOT NULL,
  `order_date` date NOT NULL,
  `joindate` date NOT NULL,
  KEY `empid` (`empid`),
  CONSTRAINT `transferdetails_ibfk_1` FOREIGN KEY (`empid`) REFERENCES `joiningdetails` (`empid`)
...
INSERT INTO `transferdetails` VALUES ('UD1001','2021-06-01','2021-06-10','TO1001','2021-05-30','2021-07-02');
